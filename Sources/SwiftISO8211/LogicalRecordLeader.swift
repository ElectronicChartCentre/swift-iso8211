...
struct LogicalRecordLeader {
    ...
    func sizeOfFieldEntry() -> UInt32 {
        return UInt32(sizeOfFieldLengthField) + UInt32(sizeOfFieldPositionField) + UInt32(sizeOfFieldTagField)
    }
    ...
    static func create(reader: BinaryReader) -> LogicalRecordLeader? {
        ...
        return LogicalRecordLeader(recordLength: recordLength, interchangeLevel: interchangeLevel, leaderIdentifier: leaderIdentifier, inlineCodeExtensionIndicator: inlineCodeExtensionIndicator, versionNumber: versionNumber, applicationIndicator: applicationIndicator, fieldControlLength: fieldControlLength, baseAddressOfFieldData: baseAddressOfFieldData, extendedCharacterSetIndicator: extendedCharacterSetIndicator, sizeOfFieldLengthField: sizeOfFieldLengthField, sizeOfFieldPositionField: sizeOfFieldPositionField, reserved: reserved, sizeOfFieldTagField: sizeOfFieldTagField)
    }
